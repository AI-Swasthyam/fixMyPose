...
class DiffDataset:
    def __init__(self, ds_name='fixmypose', split='train', isTrain=True):
...
class TorchDataset(Dataset):
    def __init__(self, dataset, max_length=80, img0_transform=None, img1_transform=None, isTrain=True):
        ...
        if isTrain:
            ...
            img0 = cv2.imread('../dataset/trikon_src.jpg')
            img1 = cv2.imread('../dataset/trikon_trg.jpg')
            f = {}
            f['img0'] = img0
            f['img1'] = img1
