...
if 'speaker' in args.train:
    train_tuple = get_tuple(args.dataset, 'train',
                            shuffle=True, drop_last=False)
    valid_tuple = get_tuple(args.dataset, 'valid_seen',
    ...
    if args.train == 'rlspeaker':
        ...
        valid_unseen_tuple = get_tuple(
            args.dataset, 'valid', shuffle=False, drop_last=False)
        scores, result = speaker.evaluate(
            valid_unseen_tuple, split="val_unseen")
        print(scores)
